...
export const getExpectedResults = (wkspUri: vscode.Uri, config: Configuration): TestResult[] => {
  ...
  const expectedResults: TestResult[] = [
    new TestResult({
      ...
      scenario_featureName: 'Config Only Discovery',
      ...
      test_id: '.../config-only/{{featurePath}}/discovery.feature/run a successful test',
      test_label: 'run a successful test',
      test_parent: '.../config-only/{{featurePath}}/discovery.feature',
      test_uri: '.../config-only/{{featurePath}}/discovery.feature'
    }),
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../config-only/{{featurePath}}/discovery.feature/run a failing test',
    ...
    new TestResult({
      ...
      test_description: undefined,
      test_error: undefined,
      test_id: '.../config-only/{{featurePath}}/discovery.feature/run a skipped test',
